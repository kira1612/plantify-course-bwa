                                            ...
                                            <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                                ...
                                                <li>
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <div className="text-fore ground text-xs font-semibold uppercase leading-relaxed">
                                                            Workspace
                                                        </div>
                                                        <Link>
                                                    ...
                                                    <ul role="list" className="-mx-2 mt-2 space-y-1">
                                                        <li>
                                                            ...
                                                            >
                                                                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border bg-white text-[0.625rem] text-foreground">
                                                                    B
                                                                </span>
